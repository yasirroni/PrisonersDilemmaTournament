...
def strategy(history, memory):
    """
    Nice Patient Reflective Tit for Tat (NPRWTT):
        ...
        4. Windowed: NPRTT but only look to some window.
    ...
    a high-scoring "loss" vs. joss. Windowed to accept enemy that become nice after 
    some cruelty.
    ...
    # window for remembering history
    WINDOW_LENGTH = 16
